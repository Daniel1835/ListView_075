package com.f55121075_daniel_irwansyah.ListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,long l) {
                if (position == 0) {
                    //clicked Daniel
                    startActivity(new Intent(MainActivity.this,Daniel.class));
                } else if (position == 1) {
                    ...
                    startActivity(new Intent(MainActivity.this, KiHajarDewantara_Activitty.class));
                } else if (position == 6) {
